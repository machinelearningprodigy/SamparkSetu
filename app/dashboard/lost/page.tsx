...
import { AlertTriangle, ArrowRight, Clock, CheckCheck, Search, Trash2, Edit } from "lucide-react"
  ...
  useEffect(() => {
    const fetchLostItems = async () => {
      ...
      try {
        ...
        toast({
          title: "Error",
          description: "Failed to load your lost items",
          variant: "destructive",
        })
      } finally {
        setIsLoading(false)
    ...
    <div className="space-y-6">
      ...
      {items.length > 0 ? (
        ...
        <Card className="bg-slate-900/70 backdrop-blur-lg border-slate-800">
          <CardHeader>
            <CardTitle>No Lost Items</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-slate-400 mb-4">You haven't reported any lost items yet.</p>
            <Button asChild>
              <Link href="/report/lost">
                <AlertTriangle className="mr-2 h-4 w-4" />
                Report a Lost Item
