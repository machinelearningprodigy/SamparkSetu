...
import { CalendarIcon, Upload, X, AlertTriangle, Loader2 } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-32">
        <div className="max-w-2xl mx-auto">
          <Card className="bg-slate-900/70 backdrop-blur-lg border-slate-800 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 via-transparent to-purple-500/5 pointer-events-none"></div>
            <CardHeader className="relative">
              <div className="flex items-center space-x-2">
                <AlertTriangle className="h-6 w-6 text-red-500" />
                <CardTitle>Report a Lost Item</CardTitle>
              </div>
              <CardDescription>Provide details about your lost item to help others identify it.</CardDescription>
            </CardHeader>
              ...
              <CardContent className="space-y-6 relative">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="bg-slate-800/50 border-slate-700 focus:border-red-500 focus:ring-red-500/20"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    required
                  >
                    <SelectTrigger className="bg-slate-800/50 border-slate-700 focus:border-red-500 focus:ring-red-500/20">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    {images.length < 3 && (
                      <label className="border-2 border-dashed border-slate-700 rounded-md flex flex-col items-center justify-center h-24 cursor-pointer hover:border-red-500 transition-colors bg-slate-800/30">
